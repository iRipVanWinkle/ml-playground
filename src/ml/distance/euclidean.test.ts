...
describe('euclideanDistance', () => {
    it('calculates zero distance for identical vectors', () => {
        ...
        const result = euclideanDistance(X, Y);
    ...
    it('calculates distance for orthogonal vectors', () => {
        ...
        expect(distance).toBeCloseTo(1.41421, 5);
    });
    ...
    it('calculates distances for multiple vectors', () => {
        ...
        expect(distances[0][1]).toBeCloseTo(1.41421, 5);
        expect(distances[1][0]).toBeCloseTo(1.41421, 5);
    });
});
